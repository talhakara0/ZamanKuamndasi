package com.talhadev.zamankumandasi.data.repository
...
class AppUsageRepository @Inject constructor(
    ...
    suspend fun setDailyLimitForChild(childUserId: String, packageName: String, appName: String, limitInMinutes: Int, parentUserId: String): Result<Unit> {
        ...
        return try {
            ...
            val child = childSnapshot.getValue(com.talhadev.zamankumandasi.data.model.User::class.java)
            ...
            val parentUser = parentSnapshot.getValue(com.talhadev.zamankumandasi.data.model.User::class.java)
    ...
    suspend fun getChildUsageByParent(parentId: String): Map<String, List<AppUsage>> {
        ...
        return try {
            ...
            val children = childrenSnapshot.children.mapNotNull { it.getValue(com.talhadev.zamankumandasi.data.model.User::class.java) }
